...
import { RoleGuard } from '../../api/roleGuard';
...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'invalidstate/:id', loadChildren: () => import('./invalid/invalidstatedemo.module').then(m => m.InvalidStateDemoModule) },
        { path: 'list', loadChildren: () => import('./list/listdemo.module').then(m => m.ListDemoModule)},
        { path: 'media/:id', loadChildren: () => import('./media/mediademo.module').then(m => m.MediaDemoModule) },
        ...
        { path: 'panel/:id', loadChildren: () => import('./panels/panelsdemo.module').then(m => m.PanelsDemoModule) },
